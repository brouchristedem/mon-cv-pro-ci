...
export function demoCV(templateId: string, couleurPrimaire = "#2563eb"): CVData {
  return {
    ...
    personalInfo: {
      ...
      email: "aicha.kouassi@email.com",
      telephone: "+225 07 12 34 56 78",
      adresse: "Abidjan, Côte d'Ivoire",
      linkedin: "linkedin.com/in/aichakouassi",
      siteWeb: "",
      autresInfos: [],
    },
    sections: [
        ...
        items: [
          {
            ...
            titre: "",
            description:
              "Spécialiste marketing digital avec 6 ans d'expérience dans le développement de stratégies de croissance pour des marques en Afrique de l'Ouest. Passionnée par la data et l'innovation.",
          },
        ],
      },
      {
