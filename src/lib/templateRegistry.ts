...
export const TEMPLATE_LIST: TemplateMeta[] = [
  ...
  { id: "template-04", nom: "Corporate", style: "Deux colonnes, style cabinet de conseil", actif: true, colonnes: 2 },
  ...
  { id: "template-10", nom: "Sidebar Clair", style: "Deux colonnes, bandeau latéral discret", actif: true, colonnes: 2 },
